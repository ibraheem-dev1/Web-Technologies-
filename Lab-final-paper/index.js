...
/**
 * ON-SALE CLIENT-SIDE PAGINATION
 * ==============================
 * Shows 10 product cards at a time on /onsale-products.
 */
$(document).ready(function () {
    ...
    var $cards = $list.find('.product_card');
    var perPage = 10;
    var totalItems = $cards.length;
    var totalPages = Math.max(Math.ceil(totalItems / perPage), 1);
    var currentPage = 1;

    var $prev = $('#onsale_prev');
    var $next = $('#onsale_next');
    var $indicator = $('#onsale_page_indicator');
    ...
    function renderPage(page) {
        ...
        $indicator.text('Page ' + currentPage + ' of ' + totalPages);
        updateButtons();
    }
